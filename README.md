...
- Personal memory retrieval — *In progress.*
...
- **AIDA** — the conversation agent. Handles input and output, and runs a tool loop for retrieval, database access, and scheduling. *In progress.*
